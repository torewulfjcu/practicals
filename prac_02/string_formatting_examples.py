...
# TRY THIS OUT - Three cases
# First case: print(random.randint(5, 20))
#   Smallest number 5, largest number 20.
# Second case: print(random.randrange(3, 10, 2))
#   This line randomly produces the numbers 3 5 7 9.
# Third case: print(random.uniform(2.5, 5.5))
#   This line produces random floating point numbers between 2.5 and 5.5.
